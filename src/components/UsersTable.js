...
const UsersTable = ({ users, onView, onEdit, onDelete, isLoading }) => {
            ...
            <tr key={user.id}>
              ...
              <td className="actions-cell">
                <div className="action-buttons">
                  ...
                  <button className="btn-edit" onClick={() => onEdit(user)} title="Edit">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M11.3333 2.00001C11.5084 1.8249 11.7163 1.68601 11.9447 1.59128C12.1731 1.49655 12.4173 1.44775 12.6667 1.44775C12.916 1.44775 13.1602 1.49655 13.3886 1.59128C13.617 1.68601 13.8249 1.8249 14 2.00001C14.1751 2.17512 14.314 2.38301 14.4087 2.61143C14.5035 2.83984 14.5523 3.08406 14.5523 3.33334C14.5523 3.58262 14.5035 3.82684 14.4087 4.05525C14.314 4.28367 14.1751 4.49156 14 4.66667L5.00001 13.6667L1.33334 14.6667L2.33334 11L11.3333 2.00001Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </button>
