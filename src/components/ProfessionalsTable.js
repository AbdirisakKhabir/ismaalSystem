...
const ProfessionalsTable = ({ professionals, onView, onEdit, onDelete, isLoading }) => {
            ...
            <tr key={p.id}>
              ...
              <td className="actions-cell">
                <div className="action-buttons">
                  ...
                  <button type="button" className="btn-edit" onClick={() => onEdit(p)} title="Edit city & professions">
